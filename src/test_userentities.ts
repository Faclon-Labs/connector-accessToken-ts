import { UserAccess, UserDetailsHeaders, UserEntitiesResponse } from './connectors/UserAccess.js';

async function testUserEntities() {
  ...
  const entitiesResponse: UserEntitiesResponse | null = await userAccess.getUserEntities(params, extraHeaders);
  console.log('User entities response:', entitiesResponse);
}
